...
import onboardingTranslation from '../../public/translations/pci-file-storage/onboarding/Messages_fr_FR.json';
import listingTranslation from '../../public/translations/pci-file-storage/listing/Messages_fr_FR.json';
